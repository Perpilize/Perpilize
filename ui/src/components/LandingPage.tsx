...
const throughputData = Array.from({ length: 50 }, (_, i) => ({
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold tracking-tight" style={{ fontSize: "1.125rem" }}>
              [PRODUCT_NAME]
            </span>
          </div>
          <div className="flex items-center gap-6">
            <a href="#architecture" className="text-sm text-foreground/80 hover:text-foreground">
              Architecture
            </a>
            <a href="#features" className="text-sm text-foreground/80 hover:text-foreground">
              Features
            </a>
            <a href="#access" className="text-sm text-foreground/80 hover:text-foreground">
              Access
            </a>
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-32">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-ultramarine-900 dark:text-ultramarine-200">
                Custom Minitia Rollup on Initia Network
              </span>
            </motion.div>
            ...
            <p className="mb-8 max-w-2xl text-muted-foreground" style={{ fontSize: "1.125rem", lineHeight: "1.7" }}>
              Custom rollup execution environment for institutional-grade perpetual contracts. Portfolio margin, sub-millisecond latency, and native cross-rollup liquidity through Interwoven architecture.
            </p>
      ...
      <section id="features" className="relative border-t border-border bg-card py-32">
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            <h2 className="mb-4 font-semibold tracking-tight" style={{ fontSize: "2.5rem" }}>
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-ultramarine-100 dark:bg-ultramarine-900/30">
                <Database className="h-6 w-6 text-ultramarine-600 dark:text-ultramarine-400" />
              </div>
              <h3 className="mb-3 font-semibold tracking-tight" style={{ fontSize: "1.25rem" }}>
                Custom Rollup Execution
              </h3>
              <p className="text-muted-foreground">
                Dedicated Minitia rollup optimized for perpetual contract execution. Isolated state, custom gas economics, and deterministic settlement on Initia L1.
              </p>
            </motion.div>
            ...
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-ultramarine-100 dark:bg-ultramarine-900/30">
                <Activity className="h-6 w-6 text-ultramarine-600 dark:text-ultramarine-400" />
              </div>
              <h3 className="mb-3 font-semibold tracking-tight" style={{ fontSize: "1.25rem" }}>
                Portfolio Margin
              </h3>
              <p className="text-muted-foreground">
                Multi-asset cross-margin with real-time risk calculation. Asset-specific haircuts, delta hedging support, and capital-efficient position management.
              </p>
            </motion.div>
            ...
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-ultramarine-100 dark:bg-ultramarine-900/30">
                <Lock className="h-6 w-6 text-ultramarine-600 dark:text-ultramarine-400" />
              </div>
              <h3 className="mb-3 font-semibold tracking-tight" style={{ fontSize: "1.25rem" }}>
                Institutional Access Controls
              </h3>
              <p className="text-muted-foreground">
                Role-based permissions, subaccount delegation, and audit-ready transaction logs. Compliance-ready architecture with configurable risk parameters.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-2 gap-16">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="mb-6 font-semibold tracking-tight" style={{ fontSize: "2.5rem" }}>
                Interwoven Stack Integration
              </h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="mb-1 font-medium">Cross-Rollup Liquidity</h4>
                    <p className="text-sm text-muted-foreground">
                      Access liquidity from connected Minitias through IBC-based messaging and unified liquidity pools.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="mb-1 font-medium">Initia L1 Settlement</h4>
                    <p className="text-sm text-muted-foreground">
                      Final settlement and oracle data anchored to Initia L1 for maximum security and data integrity.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="mb-1 font-medium">Custom Rollup Identity</h4>
                    <p className="text-sm text-muted-foreground">
                      Sovereign execution environment with custom gas token, governance, and risk parameters.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative h-full">
                <div className="space-y-6">
                  <div className="rounded-lg border border-ultramarine-300 bg-ultramarine-50 p-4 dark:border-ultramarine-700 dark:bg-ultramarine-900/30">
                    ...
                    <p className="font-semibold">[PRODUCT_NAME] Minitia</p>
                    <div className="mt-3 flex items-center gap-2">
                      <div className="h-2 w-2 rounded-full bg-success" />
                      <span className="text-sm text-muted-foreground">Active • Block 8,234,192</span>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border border-border bg-background p-4">
                    ...
                    <div className="mt-3 flex items-center gap-2">
                      <div className="h-2 w-2 rounded-full bg-success" />
                      <span className="text-sm text-muted-foreground">Finality: 2.1s avg</span>
                    </div>
                  </div>

                  <div className="flex items-center justify-center">
                    <div className="flex flex-col items-center gap-2">
                      <div className="h-8 w-0.5 bg-gradient-to-b from-ultramarine-400 to-transparent" />
                    </div>
                  </div>
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          >
            ...
            <p className="mb-8 text-muted-foreground" style={{ fontSize: "1.125rem" }}>
              Access institutional-grade perpetual trading on custom Minitia infrastructure.
              <br />
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Institutional perpetual trading on Initia Network.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><a href="#" className="hover:text-foreground">Architecture</a></li>
