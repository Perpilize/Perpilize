...
// DeductMargin reduces collateral by amount. Called by settlement keeper.
func (k Keeper) DeductMargin(ctx sdk.Context, addr string, amount math.LegacyDec) error {
...
// ExecuteLiquidation reduces a position by partialRate and deducts the penalty.
// Called by the liquidation keeper when processing MsgLiquidate.
func (k Keeper) ExecuteLiquidation(ctx sdk.Context, addr, marketID string, partialRate math.LegacyDec) error {
